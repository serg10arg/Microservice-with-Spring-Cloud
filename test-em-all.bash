...
# Definición de variables (Valores obtenidos de setup-tenant.bash)
export TENANT="dev-m1-1.eu.auth0.com" # Su dominio Auth0
export WRITER_CLIENT_ID="NCCTa45bmXBf6JHPJbEOzpdGtnjd9Ps1"
export WRITER_CLIENT_SECRET="aho0RF7vMbJWI0-Y9j1UxhU9_rop45AbLZDZLnuxHWUVnQwqS96Knl0_UaOi9oTW"

# Solicitud de Token (Flujo Client Credentials)
...
export READER_CLIENT_ID="dRcymq7Ky2ZTbTfApPI8qZfxPMa6GI7C"
export READER_CLIENT_SECRET="ZwE2Z-RNy8CuxwD0T3ZBMrcR3Zt_18TACn1QzxOaotkSmMnfDXMxmTYtmlUUejkp"
